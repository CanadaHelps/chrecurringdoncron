 ...
 */
class CRM_Chrecurringdoncron_Upgrader_Base {

  /**
   * @var CRM_Chrecurringdoncron_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Chrecurringdoncron_Upgrader(
        'chrecurringdoncron',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Chrecurringdoncron_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Chrecurringdoncron_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
